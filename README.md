...
<p align="center">
<a href="https://www.java.com/"><img width="8%" title="Java" src="mediaReadme/logo/Java.svg">
<a href="https://selenide.org/"><img width="8%" title="Selenide" src="mediaReadme/logo/Selenide.svg">
<a href="https://aerokube.com/selenoid/"><img width="8%" title="Selenoid" src="mediaReadme/logo/Selenoid.svg">
<a href="https://github.com/allure-framework/allure2"><img width="8%" title="Allure Report" src="mediaReadme/logo/Allure_Report.svg">
<a href="https://qameta.io/"><img width="8%" title="Allure TestOps" src="mediaReadme/logo/AllureTestOps.svg">
<a href="https://gradle.org/"><img width="8%" title="Gradle" src="mediaReadme/logo/Gradle.svg">
<a href="https://junit.org/junit5/"><img width="8%" title="JUnit5" src="mediaReadme/logo/JUnit5.svg">
...
## <img width="7%" style="vertical-align:middle" title="Allure TestOps" src="mediaReadme/logo/AllureTestOps.svg"> [Allure TestOps](https://allure.autotests.cloud/project/3993/dashboards) : обзор результатов проекта
...
## <img width="7%" style="vertical-align:middle" title="Jira" src="mediaReadme/logo/Jira.svg"> [Jira](https://jira.autotests.cloud/browse/HOMEWORK-1109) : выведение результатов в таски
